...
function handleCategoryChange(event) {
 ...
 return (
    ...
    <h3>Design di una pagina che utlizza le API di ChuckNorris per generare alla pressione di<br></br> un pulsante una battura del tipo che selezioni nel menu a tendini qui sotto.</h3>
  </header>
